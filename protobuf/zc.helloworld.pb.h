...
#ifndef PROTOBUF_zc_2ehelloworld_2eproto_INCLUDED
#define PROTOBUF_zc_2ehelloworld_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::zc::helloworld* Arena::Create< ::zc::helloworld>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace zc {
...
class helloworld : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:zc.helloworld) */ {
 public:
  helloworld();
  virtual ~helloworld();
  ...
  // @@protoc_insertion_point(class_scope:zc.helloworld)
 private:
  void set_has_id();
  void clear_has_id();
  void set_has_str();
  ...
  friend struct ::protobuf_zc_2ehelloworld_2eproto::TableStruct;
  friend void ::protobuf_zc_2ehelloworld_2eproto::InitDefaultshelloworldImpl();
};
// ===================================================================
...
inline ::google::protobuf::int32 helloworld::id() const {
  // @@protoc_insertion_point(field_get:zc.helloworld.id)
  return id_;
}
inline void helloworld::set_id(::google::protobuf::int32 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:zc.helloworld.id)
}
...
inline const ::std::string& helloworld::str() const {
  // @@protoc_insertion_point(field_get:zc.helloworld.str)
  return str_.GetNoArena();
}
inline void helloworld::set_str(const ::std::string& value) {
  set_has_str();
  str_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:zc.helloworld.str)
}
#if LANG_CXX11
inline void helloworld::set_str(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:zc.helloworld.str)
}
#endif
inline void helloworld::set_str(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:zc.helloworld.str)
}
inline void helloworld::set_str(const char* value, size_t size) {
  set_has_str();
  str_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:zc.helloworld.str)
}
inline ::std::string* helloworld::mutable_str() {
  set_has_str();
  // @@protoc_insertion_point(field_mutable:zc.helloworld.str)
  return str_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* helloworld::release_str() {
  // @@protoc_insertion_point(field_release:zc.helloworld.str)
  clear_has_str();
...
inline void helloworld::set_allocated_str(::std::string* str) {
  ...
  // @@protoc_insertion_point(field_set_allocated:zc.helloworld.str)
}
...
inline ::google::protobuf::int32 helloworld::opt() const {
  // @@protoc_insertion_point(field_get:zc.helloworld.opt)
  return opt_;
}
inline void helloworld::set_opt(::google::protobuf::int32 value) {
  set_has_opt();
  opt_ = value;
  // @@protoc_insertion_point(field_set:zc.helloworld.opt)
}
...
#endif  // PROTOBUF_zc_2ehelloworld_2eproto_INCLUDED
