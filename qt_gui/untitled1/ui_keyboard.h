...
"background-color: rgb(255, 255, 255);"));
    ...
    {
        backButton->setText(QApplication::translate("Keyboard", "Back", Q_NULLPTR));
        clear->setText(QApplication::translate("Keyboard", "Clear", Q_NULLPTR));
        ...
        space->setText(QApplication::translate("Keyboard", "Space", Q_NULLPTR));
